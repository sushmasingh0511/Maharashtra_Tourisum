...
Statement stmt=null;
ResultSet rs=null;
String Travel = request.getParameter("TravelsId");
...
try
{
	...
	String Query = "Select * from travelsmaster where TravelsId='"+Travel+"'";
...
int DisRow=0;
	...
	<tr class= <%=(DisRow%2!=0)? "row_even" : "row_odd"%>>
		<td><a href="#" onclick="sendInfo('<%=Travel%>')"><%=Travel%></a></td>
		<td><%=Travels%></td>
		<td><%=Location%></td>
		<td><%=Address%></td>
		<td><%=AgentName%></td>
